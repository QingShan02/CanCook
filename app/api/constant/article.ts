...
export const query = {
    ...
    findByPage:"select a.id ,a.title, a.content, a.thumbnail, TO_CHAR(createDate, 'dd/MM/yyyy') as createDate, s.name as staffName, a.view from article a join staff s on s.id = a.staffId order by a.id ASC  offset $1 limit 8",
